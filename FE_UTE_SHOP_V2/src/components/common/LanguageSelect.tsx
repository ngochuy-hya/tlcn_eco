...
import { getLanguageOptions, shopConfig } from "@/config/shop";
...
export default function LanguageSelect({
  ...
  const defaultLanguage = languageOptions.find((lang) => lang.id === shopConfig.defaultLanguage) || languageOptions[0];
