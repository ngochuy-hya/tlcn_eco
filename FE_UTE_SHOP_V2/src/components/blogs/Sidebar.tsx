...
export default function Sidebar({
  ...
  return (
    <div className={prentClass}>
          ...
          {loading ? (
            ...
            <ul className="category-blog-list">
              {categories.map((category) => (
                <li key={category.id}>
                  <Link to={`/blog-category/${category.slug}`} className="text-md link">
            ...
            <ul className="recent-blog-list">
              {recentPosts.map((post) => (
                <li className="hover-img" key={post.id}>
                  <div className="image">
                    <Link to={`/blog-single/${post.id}`} className="img-style d-block">
                      <img
                  ...
                  <div className="post-content">
                    <Link to={`/blog-single/${post.id}`} className="link text-md fw-medium">
                      {post.title}
                    </Link>
      ...
      <div className="sb-item">
        <p className="sb-title text-xl fw-medium">Thẻ</p>
        <div className="sb-content entry-tag">
          {loading ? (
            ...
            <ul className="tag-blog-list style-list">
              {categories.map((category) => (
                <li key={category.id}>
                  <Link to={`/blog-category/${category.slug}`} className="tag-line">
                    {category.name}
                  </Link>
                </li>
              ))}
