      ...
      <div className="flat-spacing pt-0">
        <div className="container">
          <p className="text text-md text-center">
            Bộ sưu tập nữ của chúng tôi mang đến cho bạn sự kết hợp độc đáo giữa sự tinh tế cổ điển
            và các xu hướng thời trang mới nhất. Dù bạn đang tìm kiếm
            trang phục hàng ngày linh hoạt, trang phục công sở phong cách, hay những món đồ nổi bật cho
            những dịp đặc biệt, bộ sưu tập này có tất cả. Mỗi sản phẩm được
            chế tác cẩn thận với sự chú ý đến từng chi tiết, sử dụng chất liệu
            cao cấp để đảm bảo sự thoải mái lâu dài và vừa vặn hoàn hảo. Từ những chiếc áo sơ mi
            thanh lịch và quần may đo đến những chiếc váy tuyệt đẹp và áo khoác, bạn sẽ
            tìm thấy những món đồ kết hợp hài hòa giữa sự thanh lịch và tính thực tế. Bộ sưu tập
            của chúng tôi được thiết kế để trao quyền cho phụ nữ với sự tự tin và phong cách,
            bất kể dịp nào.
          </p>
          <p className="mt_12 text-md text-center">
            Tìm kiếm thêm? Đừng bỏ lỡ các bộ sưu tập thú vị khác của chúng tôi
            cho{" "}
          ...
          >
              ...
              <div className="tf-icon-box style-2">
                ...
                <div className="content">
                  ...
                  <p className="desc text-grey-2">
                    Miễn phí vận chuyển cho tất cả đơn hàng trên {formatPrice(3600000)}
                  </p>
                </div>
              </div>
            </SwiperSlide>
            <SwiperSlide className="swiper-slide">
              <div className="tf-icon-box style-2">
                ...
                <div className="content">
                  <div className="title">Đổi trả dễ dàng</div>
                  <p className="desc text-grey-2">
                    Đổi trả không rắc rối cho trải nghiệm mua sắm không lo lắng.
                  </p>
                </div>
              </div>
            </SwiperSlide>
            <SwiperSlide className="swiper-slide">
              <div className="tf-icon-box style-2">
                ...
                <div className="content">
                  ...
                  <p className="desc text-grey-2">
                    Mua sắm với sự tự tin, được bảo hành một năm.
                  </p>
                </div>
              </div>
            </SwiperSlide>
